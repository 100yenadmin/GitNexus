...
const OPTION_DESCRIPTION_KEYS = {
  ...
  'analyze|--preserve-verified-embeddings': 'help.option.analyze.preserveVerifiedEmbeddings',
  'analyze|--dry-run': 'help.option.analyze.dryRun',
  'analyze|--json': 'help.option.analyze.json',
  'analyze|--plan-digest <sha256>': 'help.option.analyze.planDigest',
  'analyze|--max-reembed-nodes <n>': 'help.option.analyze.maxReembedNodes',
